...
$.fn.ycp = function(j) {
    ...
    function ycp_list(h, f, g, k, l) {
        $.ajax({
            ...
            d += '<span class="tombol vid-next" title="Next videos">Next</span><span class="about" title="ycp.js"><a href="https://aidetools13.github.io/Page/rest-api.html" target="_BLANK">♥</a></span></div><div class="handap">';
            $.each(c.items, (i, a) => {
